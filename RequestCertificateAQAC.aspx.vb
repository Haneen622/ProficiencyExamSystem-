...
Public Class RequestCertificateAQAC
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            Try
                ...
                ds = obj.BindCertificateRequests()
                g.DataSource = ds
                g.DataBind()
    ...
    Protected Sub g_RowCommand(sender As Object, e As GridViewCommandEventArgs)
        If e.CommandName = "Approve" Then
            ...
            obj.ApproveRequest(userId) ' Assuming this method updates the approval status in DB
            ...
            ' Update the status in the database (should be done in db directly during approval)
        ...
        ElseIf e.CommandName = "Reject" Then
            ...
            obj.RejectRequest(userId) ' Assuming this method updates the rejection status in DB
            ...
            ' Update the status in the database (should be done in db directly during rejection)
            Dim lblStatus As Label = DirectCast(row.FindControl("lblStatus"), Label)
            If lblStatus IsNot Nothing Then
